...
import com.talla.backmanager.Entites.FluxFinanciers.Beans.Solde;
...
@Data
@Service
public class LectureCodax implements ILectureCoda {
    ...
    public LectureCodax(CompteRepository compteRepository, CodaRepository codaRepository) {
    ...
    public static void setListeCompte(List<Compte> listeCompte) {
        LectureCodax.listeCompte = listeCompte;
    }
